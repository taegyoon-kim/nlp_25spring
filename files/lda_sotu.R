###############################################################################   
#### Guide Coding: Topic Model                                             ####
#### 2025 Apr 8, Taegyoon Kim                                              ####
###############################################################################
...
result <- FindTopicsNumber(
  ...
  metrics = c("Griffiths2004", # log-likelihood (predictive power on unseen data; higher-is-better)
              "CaoJuan2009"), # exclusivity (topics are similar; lower-is-better)
  method = "Gibbs",
  verbose = TRUE
  )
...
# 20 most likely terms within the term probabilities beta of the inferred topics
